...
func TestGetKnownServiceReturnsExpectedConstructorResult(t *testing.T) {
	...
	var serviceConstructor = func(get Get) any { return service }
...
func TestGetKnownServiceImplementsSingleton(t *testing.T) {
	...
	instanceCount := 0
	var serviceConstructor = func(get Get) any {
		instanceCount += 1
...
func TestUpdateOfExistingServiceReplaces(t *testing.T) {
	...
	var originalConstructor = func(get Get) any { return serviceType{value: original} }
	sut := NewContainer(ServiceConstructorMap{serviceName: originalConstructor})
	var replacementConstructor = func(get Get) any { return serviceType{value: replacement} }
...
func TestGetInsideGetReturnsAsExpected(t *testing.T) {
	...
	sut := NewContainer(ServiceConstructorMap{
		fooName: func(get Get) any { return &foo{FooMessage: fooName} },
		barName: func(get Get) any { return &bar{BarMessage: barName, Foo: get(fooName).(*foo)} },
	})
