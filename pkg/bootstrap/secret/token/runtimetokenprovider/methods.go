...
type runtimetokenprovider struct {
	...
	getTLSConfig         func(context.Context, log.Logger) (*tls.Config, error)
	source               *workloadapi.X509Source
}

// NewRuntimeTokenProvider creates a new runtime token provider
func NewRuntimeTokenProvider(ctx context.Context, lc log.Logger,
...
func (p *runtimetokenprovider) GetRawToken(serviceKey string) (string, error) {
	...
	providerURL, err := p.runtimeTokenProvider.BuildProviderURL(secrets.SpiffeTokenProviderGetTokenAPI)
	if err != nil {
...
func (p *runtimetokenprovider) SetTLSConfigFunc(tlsConfFunc func(context.Context, log.Logger) (*tls.Config, error)) {
	p.getTLSConfig = tlsConfFunc
}

func (p *runtimetokenprovider) defaultGetTLSConfig(ctx context.Context, lc log.Logger) (*tls.Config, error) {
